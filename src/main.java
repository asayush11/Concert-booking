...
public class main {
    ...
    public static void main(String[] args){
        ...
        Concert concert1 = new Concert("C001", "Artist 1", "Venue 1", dateTime, concert1Seats);
        ...
        // Search concerts
        List<Concert> searchResults = bookingSystem.searchConcerts("Artist 1", "Venue 1", dateTime);
